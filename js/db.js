...
export function savePositions(){dbSave('positions',{entries:S.readingPositions,audio:S.audioPositions},true)}
...
if(pos.exists){S.readingPositions=pos.data().entries||{};S.audioPositions=pos.data().audio||{}}
